...
export type AddressAPIClient = {
     ...
     * @throws {APIError} If the request fails.
     */
    createPayloadSignature(walletId: string, addressid: string, createPayloadSignatureRequest?: CreatePayloadSignatureRequest, options?: AxiosRequestConfig): AxiosPromise<PayloadSignatureModel>;
    /**
     ...
     * @throws {APIError} If the request fails.
     */
    getPayloadSignature(walletId: string, addressid: string, payloadSignatureId: string, options?: AxiosRequestConfig): AxiosPromise<PayloadSignatureModel>;
    /**
     ...
     * @throws {APIError} If the request fails.
     */
    listPayloadSignatures(walletId: string, addressid: string, limit?: number, page?: string, options?: AxiosRequestConfig): AxiosPromise<PayloadSignatureList>;
};
/**
...
export type WalletStakeAPIClient = {
    broadcastStakingOperation(walletId: string, addressId: string, stakingOperationId: string, broadcastStakingOperationRequest: BroadcastStakingOperationRequest, options?: AxiosRequestConfig): AxiosPromise<StakingOperationModel>;
    createStakingOperation(walletId: string, addressId: string, createStakingOperationRequest: CreateStakingOperationRequest, options?: AxiosRequestConfig): AxiosPromise<StakingOperationModel>;
    getStakingOperation(walletId: string, addressId: string, stakingOperationId: string, options?: AxiosRequestConfig): AxiosPromise<StakingOperationModel>;
};
export type StakeAPIClient = {
     ...
     * @param options - Axios request options.
     */
    fetchHistoricalStakingBalances(networkId: string, assetId: string, addressId: string, startTime: string, endTime: string, limit?: number, page?: string, options?: AxiosRequestConfig): AxiosPromise<FetchHistoricalStakingBalances200Response>;
    /**
     ...
     * @param options - Axios request options.
     */
    listValidators(networkId: string, assetId: string, status?: APIValidatorStatus, limit?: number, page?: string, options?: AxiosRequestConfig): AxiosPromise<ValidatorList>;
    /**
...
export type ExternalSmartContractAPIClient = {
     ...
     * @throws {APIError} If the request fails.
     */
    listContractEvents(networkId: string, protocolName: string, contractAddress: string, contractName: string, eventName: string, fromBlockHeight: number, toBlockHeight: number, nextPage?: string): AxiosPromise<ContractEventList>;
};
/**
 ...
 */
export declare enum SponsoredSendStatus {
    PENDING = "pending",
    SIGNED = "signed",
    SUBMITTED = "submitted",
    COMPLETE = "complete",
 ...
 */
export declare enum StakingRewardFormat {
    USD = "usd",
    NATIVE = "native"
}
/**
 ...
 */
export declare enum PayloadSignatureStatus {
    PENDING = "pending",
    SIGNED = "signed",
    FAILED = "failed"
}
 ...
 */
export declare enum FundOperationStatus {
    PENDING = "pending",
    COMPLETE = "complete",
    FAILED = "failed"
}
 ...
 */
export declare function isWalletData(data: unknown): data is WalletData;
/**
 ...
 */
export declare function isMnemonicSeedPhrase(data: unknown): data is MnemonicSeedPhrase;
/**
...
export interface WebhookApiClient {
     ...
     */
    createWalletWebhook(walletId?: string, createWalletWebhookRequest?: CreateWalletWebhookRequest, options?: RawAxiosRequestConfig): AxiosPromise<WebhookModel>;
    /**
...
export type ContractInvocationAPIClient = {
     ...
     * @throws {APIError} If the request fails.
     */
    broadcastContractInvocation(walletId: string, addressId: string, contractInvocationId: string, broadcastContractInvocationRequest: BroadcastContractInvocationRequest, options?: AxiosRequestConfig): AxiosPromise<ContractInvocationModel>;
    /**
     ...
     * @throws {APIError} If the request fails.
     */
    createContractInvocation(walletId: string, addressId: string, createContractInvocationRequest: CreateContractInvocationRequest, options?: AxiosRequestConfig): AxiosPromise<ContractInvocationModel>;
    /**
     ...
     * @throws {APIError} If the request fails.
     */
    getContractInvocation(walletId: string, addressId: string, contractInvocationId: string, options?: AxiosRequestConfig): AxiosPromise<ContractInvocationModel>;
    /**
     ...
     * @throws {APIError} If the request fails.
     */
    listContractInvocations(walletId: string, addressId: string, limit?: number, page?: string, options?: AxiosRequestConfig): AxiosPromise<ContractInvocationList>;
};
export interface SmartContractAPIClient {
     ...
     * @throws {APIError} If the request fails.
     */
    createSmartContract(walletId: string, addressId: string, createSmartContractRequest: CreateSmartContractRequest, options?: RawAxiosRequestConfig): AxiosPromise<SmartContractModel>;
    /**
     ...
     * @throws {APIError} If the request fails.
     */
    getSmartContract(walletId: string, addressId: string, smartContractId: string, options?: RawAxiosRequestConfig): AxiosPromise<SmartContractModel>;
    /**
     ...
     * @throws {APIError} If the request fails.
     */
    deploySmartContract(walletId: string, addressId: string, smartContractId: string, deploySmartContractRequest: DeploySmartContractRequest, options?: RawAxiosRequestConfig): AxiosPromise<SmartContractModel>;
    /**
     * Read a contract
     *
     * @param networkId - Unique identifier for the blockchain network
     ...
     * @throws {APIError} If the request fails
     */
    readContract(networkId: string, contractAddress: string, readContractRequest: ReadContractRequest): AxiosPromise<SolidityValue>;
    /**
     ...
     * @throws {APIError} If the request fails
     */
    registerSmartContract(networkId: string, contractAddress: string, registerSmartContractRequest: RegisterSmartContractRequest, options?: RawAxiosRequestConfig): AxiosPromise<SmartContractModel>;
    /**
     ...
     * @throws {APIError} If the request fails
     */
    updateSmartContract(networkId: string, contractAddress: string, updateSmartContractRequest: UpdateSmartContractRequest, options?: RawAxiosRequestConfig): AxiosPromise<SmartContractModel>;
}
export interface FundOperationApiClient {
     ...
     * @throws {APIError} If the request fails
     */
    getFundOperation(walletId: string, addressId: string, fundOperationId: string, options?: RawAxiosRequestConfig): AxiosPromise<FundOperationModel>;
    /**
     ...
     * @throws {APIError} If the request fails
     */
    createFundOperation(walletId: string, addressId: string, createFundOperationRequest: CreateFundOperationRequest, options?: RawAxiosRequestConfig): AxiosPromise<FundOperationModel>;
    /**
     ...
     * @throws {APIError} If the request fails.
     */
    createFundQuote(walletId: string, addressId: string, createFundQuoteRequest: CreateFundQuoteRequest, options?: RawAxiosRequestConfig): AxiosPromise<FundQuoteModel>;
}
